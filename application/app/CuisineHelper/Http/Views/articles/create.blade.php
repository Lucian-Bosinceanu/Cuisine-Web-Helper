            ...
            <form action="{{ route("articles.store") }}" method="POST" id="articles-form" enctype="multipart/form-data">
                <section class="recipe-section">
                    <div class="content">
                        ...
                        <input type="text" name="add" id="articles-title-add" placeholder="Enter articles title" required>

                        <label for="articles-site-add">Link:</label>
                        <input type="url" name="site" id="articles-site-add" placeholder="Enter article URL" required>

                        <label for="articles-description-add">Description:</label>
                        <textarea name="description" id="articles-description-add" placeholder="Enter a description" required></textarea>
